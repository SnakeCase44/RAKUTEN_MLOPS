...
def run(role=None):
    ...
    with col2:
        ...
        if role == "admin":
            st.info("Vous êtes connecté en tant qu'administrateur. Vous avez accès à toutes les fonctionnalités.")
        elif role == "dev":
            st.info("Vous êtes connecté en tant que développeur. Vous avez accès à toutes les fonctionnalités.")
        elif role == "client":
            st.info("Vous êtes connecté en tant que client. Votre accès est limité à certaines fonctionnalités.")
